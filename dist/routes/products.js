...
router.get('/:productcode', ProductsController_1.ProductsController.prototype.getOneProduct);
router.get('/category/:categoryId', ProductsController_1.ProductsController.prototype.productsByCategory);
router.get('/categories/all', ProductsController_1.ProductsController.prototype.categories);
